...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_OLD_UNOWN_B ... SPECIES_OLD_UNOWN_Z] = gMonIcon_QuestionMark,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_HO_OH] = 1,
    [SPECIES_CELEBI] = 1,
    [SPECIES_OLD_UNOWN_B ... SPECIES_OLD_UNOWN_Z] = 0,
    [SPECIES_TREECKO] = 1,
    [SPECIES_GROVYLE] = 1,
    [SPECIES_SCEPTILE] = 1,
    [SPECIES_TORCHIC] = 0,
    ...
    [SPECIES_GOLETT] = 0,
    [SPECIES_GOLURK] = 0,
    [SPECIES_PAWNIARD] = 1, //TODO
    [SPECIES_BISHARP] = 1, //TODO
