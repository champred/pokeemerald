...
static const struct MonForme sTerrainToCloak[] = {
    ...
    [BATTLE_TERRAIN_SAND ... BATTLE_TERRAIN_CAVE] = {SANDY_CLOAK, TYPE_GROUND},
    [BATTLE_TERRAIN_BUILDING] = {TRASH_CLOAK, TYPE_STEEL},
    [BATTLE_TERRAIN_PLAIN] = {PLANT_CLOAK, TYPE_GRASS},
    [BATTLE_TERRAIN_GYM ... BATTLE_TERRAIN_CHAMPION] = {TRASH_CLOAK, TYPE_STEEL},
};

static const struct MonForme sRotomAppliances[] = {
    {NORMAL_ROTOM, TYPE_GHOST},
    {HEAT_ROTOM, TYPE_FIRE},
    {FROST_ROTOM, TYPE_ICE},
    {MOW_ROTOM, TYPE_GRASS},
};
