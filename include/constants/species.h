...
#define HOENN_SPECIES_END SPECIES_CHIMECHO

#if GAME_GENERATION>=4
#define SPECIES_TURTWIG (HOENN_SPECIES_END+1)
#define SPECIES_GROTLE (HOENN_SPECIES_END+2)
#define SPECIES_TORTERRA (HOENN_SPECIES_END+3)
#define SPECIES_CHIMCHAR (HOENN_SPECIES_END+4)
#define SPECIES_MONFERNO (HOENN_SPECIES_END+5)
#define SPECIES_INFERNAPE (HOENN_SPECIES_END+6)
#define SPECIES_PIPLUP (HOENN_SPECIES_END+7)
#define SPECIES_PRINPLUP (HOENN_SPECIES_END+8)
#define SPECIES_EMPOLEON (HOENN_SPECIES_END+9)
#define SPECIES_STARLY (HOENN_SPECIES_END+10)
#define SPECIES_STARAVIA (HOENN_SPECIES_END+11)
#define SPECIES_STARAPTOR (HOENN_SPECIES_END+12)
#define SPECIES_BIDOOF (HOENN_SPECIES_END+13)
#define SPECIES_BIBAREL (HOENN_SPECIES_END+14)
#define SPECIES_KRICKETOT (HOENN_SPECIES_END+15)
#define SPECIES_KRICKETUNE (HOENN_SPECIES_END+16)
#define SPECIES_SHINX (HOENN_SPECIES_END+17)
#define SPECIES_LUXIO (HOENN_SPECIES_END+18)
#define SPECIES_LUXRAY (HOENN_SPECIES_END+19)
#define SPECIES_BUDEW (HOENN_SPECIES_END+20)
#define SPECIES_ROSERADE (HOENN_SPECIES_END+21)
#define SPECIES_CRANIDOS (HOENN_SPECIES_END+22)
#define SPECIES_RAMPARDOS (HOENN_SPECIES_END+23)
#define SPECIES_SHIELDON (HOENN_SPECIES_END+24)
#define SPECIES_BASTIODON (HOENN_SPECIES_END+25)
#define SPECIES_BURMY (HOENN_SPECIES_END+26)
#define SPECIES_WORMADAM (HOENN_SPECIES_END+27)
#define SPECIES_MOTHIM (HOENN_SPECIES_END+28)
#define SPECIES_COMBEE (HOENN_SPECIES_END+29)
#define SPECIES_VESPIQUEN (HOENN_SPECIES_END+30)
#define SPECIES_PACHIRISU (HOENN_SPECIES_END+31)
#define SPECIES_BUIZEL (HOENN_SPECIES_END+32)
#define SPECIES_FLOATZEL (HOENN_SPECIES_END+33)
#define SPECIES_CHERUBI (HOENN_SPECIES_END+34)
#define SPECIES_CHERRIM (HOENN_SPECIES_END+35)
#define SPECIES_SHELLOS (HOENN_SPECIES_END+36)
#define SPECIES_GASTRODON (HOENN_SPECIES_END+37)
#define SPECIES_AMBIPOM (HOENN_SPECIES_END+38)
#define SPECIES_DRIFLOON (HOENN_SPECIES_END+39)
#define SPECIES_DRIFBLIM (HOENN_SPECIES_END+40)
#define SPECIES_BUNEARY (HOENN_SPECIES_END+41)
#define SPECIES_LOPUNNY (HOENN_SPECIES_END+42)
#define SPECIES_MISMAGIUS (HOENN_SPECIES_END+43)
#define SPECIES_HONCHKROW (HOENN_SPECIES_END+44)
#define SPECIES_GLAMEOW (HOENN_SPECIES_END+45)
#define SPECIES_PURUGLY (HOENN_SPECIES_END+46)
#define SPECIES_CHINGLING (HOENN_SPECIES_END+47)
#define SPECIES_STUNKY (HOENN_SPECIES_END+48)
#define SPECIES_SKUNTANK (HOENN_SPECIES_END+49)
#define SPECIES_BRONZOR (HOENN_SPECIES_END+50)
#define SPECIES_BRONZONG (HOENN_SPECIES_END+51)
#define SPECIES_BONSLY (HOENN_SPECIES_END+52)
#define SPECIES_MIME_JR (HOENN_SPECIES_END+53)
#define SPECIES_HAPPINY (HOENN_SPECIES_END+54)
#define SPECIES_CHATOT (HOENN_SPECIES_END+55)
#define SPECIES_SPIRITOMB (HOENN_SPECIES_END+56)
#define SPECIES_GIBLE (HOENN_SPECIES_END+57)
#define SPECIES_GABITE (HOENN_SPECIES_END+58)
#define SPECIES_GARCHOMP (HOENN_SPECIES_END+59)
#define SPECIES_MUNCHLAX (HOENN_SPECIES_END+60)
#define SPECIES_RIOLU (HOENN_SPECIES_END+61)
#define SPECIES_LUCARIO (HOENN_SPECIES_END+62)
#define SPECIES_HIPPOPOTAS (HOENN_SPECIES_END+63)
#define SPECIES_HIPPOWDON (HOENN_SPECIES_END+64)
#define SPECIES_SKORUPI (HOENN_SPECIES_END+65)
#define SPECIES_DRAPION (HOENN_SPECIES_END+66)
#define SPECIES_CROAGUNK (HOENN_SPECIES_END+67)
#define SPECIES_TOXICROAK (HOENN_SPECIES_END+68)
#define SPECIES_CARNIVINE (HOENN_SPECIES_END+69)
#define SPECIES_FINNEON (HOENN_SPECIES_END+70)
#define SPECIES_LUMINEON (HOENN_SPECIES_END+71)
#define SPECIES_MANTYKE (HOENN_SPECIES_END+72)
#define SPECIES_SNOVER (HOENN_SPECIES_END+73)
#define SPECIES_ABOMASNOW (HOENN_SPECIES_END+74)
#define SPECIES_WEAVILE (HOENN_SPECIES_END+75)
#define SPECIES_MAGNEZONE (HOENN_SPECIES_END+76)
#define SPECIES_LICKILICKY (HOENN_SPECIES_END+77)
#define SPECIES_RHYPERIOR (HOENN_SPECIES_END+78)
#define SPECIES_TANGROWTH (HOENN_SPECIES_END+79)
#define SPECIES_ELECTIVIRE (HOENN_SPECIES_END+80)
#define SPECIES_MAGMORTAR (HOENN_SPECIES_END+81)
#define SPECIES_TOGEKISS (HOENN_SPECIES_END+82)
#define SPECIES_YANMEGA (HOENN_SPECIES_END+83)
#define SPECIES_LEAFEON (HOENN_SPECIES_END+84)
#define SPECIES_GLACEON (HOENN_SPECIES_END+85)
#define SPECIES_GLISCOR (HOENN_SPECIES_END+86)
#define SPECIES_MAMOSWINE (HOENN_SPECIES_END+87)
#define SPECIES_PORYGON_Z (HOENN_SPECIES_END+88)
#define SPECIES_GALLADE (HOENN_SPECIES_END+89)
#define SPECIES_PROBOPASS (HOENN_SPECIES_END+90)
#define SPECIES_DUSKNOIR (HOENN_SPECIES_END+91)
#define SPECIES_FROSLASS (HOENN_SPECIES_END+92)
#define SPECIES_ROTOM (HOENN_SPECIES_END+93)
#define SINNOH_SPECIES_END SPECIES_ROTOM
#endif

#if GAME_GENERATION>=5
#define SPECIES_SNIVY (SINNOH_SPECIES_END+1)
#define SPECIES_SERVINE (SINNOH_SPECIES_END+2)
#define SPECIES_SERPERIOR (SINNOH_SPECIES_END+3)
#define SPECIES_TEPIG (SINNOH_SPECIES_END+4)
#define SPECIES_PIGNITE (SINNOH_SPECIES_END+5)
#define SPECIES_EMBOAR (SINNOH_SPECIES_END+6)
#define SPECIES_OSHAWOTT (SINNOH_SPECIES_END+7)
#define SPECIES_DEWOTT (SINNOH_SPECIES_END+8)
#define SPECIES_SAMUROTT (SINNOH_SPECIES_END+9)
#define SPECIES_PATRAT (SINNOH_SPECIES_END+10)
#define SPECIES_WATCHOG (SINNOH_SPECIES_END+11)
#define SPECIES_LILLIPUP (SINNOH_SPECIES_END+12)
#define SPECIES_HERDIER (SINNOH_SPECIES_END+13)
#define SPECIES_STOUTLAND (SINNOH_SPECIES_END+14)
#define SPECIES_PURRLOIN (SINNOH_SPECIES_END+15)
#define SPECIES_LIEPARD (SINNOH_SPECIES_END+16)
#define SPECIES_PANSAGE (SINNOH_SPECIES_END+17)
#define SPECIES_SIMISAGE (SINNOH_SPECIES_END+18)
#define SPECIES_PANSEAR (SINNOH_SPECIES_END+19)
#define SPECIES_SIMISEAR (SINNOH_SPECIES_END+20)
#define SPECIES_PANPOUR (SINNOH_SPECIES_END+21)
#define SPECIES_SIMIPOUR (SINNOH_SPECIES_END+22)
#define SPECIES_MUNNA (SINNOH_SPECIES_END+23)
#define SPECIES_MUSHARNA (SINNOH_SPECIES_END+24)
#define SPECIES_PIDOVE (SINNOH_SPECIES_END+25)
#define SPECIES_TRANQUILL (SINNOH_SPECIES_END+26)
#define SPECIES_UNFEZANT (SINNOH_SPECIES_END+27)
#define SPECIES_BLITZLE (SINNOH_SPECIES_END+28)
#define SPECIES_ZEBSTRIKA (SINNOH_SPECIES_END+29)
#define SPECIES_ROGGENROLA (SINNOH_SPECIES_END+30)
#define SPECIES_BOLDORE (SINNOH_SPECIES_END+31)
#define SPECIES_GIGALITH (SINNOH_SPECIES_END+32)
#define SPECIES_WOOBAT (SINNOH_SPECIES_END+33)
#define SPECIES_SWOOBAT (SINNOH_SPECIES_END+34)
#define SPECIES_DRILBUR (SINNOH_SPECIES_END+35)
#define SPECIES_EXCADRILL (SINNOH_SPECIES_END+36)
#define SPECIES_AUDINO (SINNOH_SPECIES_END+37)
#define SPECIES_TIMBURR (SINNOH_SPECIES_END+38)
#define SPECIES_GURDURR (SINNOH_SPECIES_END+39)
#define SPECIES_CONKELDURR (SINNOH_SPECIES_END+40)
#define SPECIES_TYMPOLE (SINNOH_SPECIES_END+41)
#define SPECIES_PALPITOAD (SINNOH_SPECIES_END+42)
#define SPECIES_SEISMITOAD (SINNOH_SPECIES_END+43)
#define SPECIES_THROH (SINNOH_SPECIES_END+44)
#define SPECIES_SAWK (SINNOH_SPECIES_END+45)
#define SPECIES_SEWADDLE (SINNOH_SPECIES_END+46)
#define SPECIES_SWADLOON (SINNOH_SPECIES_END+47)
#define SPECIES_LEAVANNY (SINNOH_SPECIES_END+48)
#define SPECIES_VENIPEDE (SINNOH_SPECIES_END+49)
#define SPECIES_WHIRLIPEDE (SINNOH_SPECIES_END+50)
#define SPECIES_SCOLIPEDE (SINNOH_SPECIES_END+51)
#define SPECIES_COTTONEE (SINNOH_SPECIES_END+52)
#define SPECIES_WHIMSICOTT (SINNOH_SPECIES_END+53)
#define SPECIES_PETILIL (SINNOH_SPECIES_END+54)
#define SPECIES_LILLIGANT (SINNOH_SPECIES_END+55)
#define SPECIES_BASCULIN (SINNOH_SPECIES_END+56)
#define SPECIES_SANDILE (SINNOH_SPECIES_END+57)
#define SPECIES_KROKOROK (SINNOH_SPECIES_END+58)
#define SPECIES_KROOKODILE (SINNOH_SPECIES_END+59)
#define SPECIES_DARUMAKA (SINNOH_SPECIES_END+60)
#define SPECIES_DARMANITAN (SINNOH_SPECIES_END+61)
#define SPECIES_MARACTUS (SINNOH_SPECIES_END+62)
#define SPECIES_DWEBBLE (SINNOH_SPECIES_END+63)
#define SPECIES_CRUSTLE (SINNOH_SPECIES_END+64)
#define SPECIES_SCRAGGY (SINNOH_SPECIES_END+65)
#define SPECIES_SCRAFTY (SINNOH_SPECIES_END+66)
#define SPECIES_SIGILYPH (SINNOH_SPECIES_END+67)
#define SPECIES_YAMASK (SINNOH_SPECIES_END+68)
#define SPECIES_COFAGRIGUS (SINNOH_SPECIES_END+69)
#define SPECIES_TIRTOUGA (SINNOH_SPECIES_END+70)
#define SPECIES_CARRACOSTA (SINNOH_SPECIES_END+71)
#define SPECIES_ARCHEN (SINNOH_SPECIES_END+72)
#define SPECIES_ARCHEOPS (SINNOH_SPECIES_END+73)
#define SPECIES_TRUBBISH (SINNOH_SPECIES_END+74)
#define SPECIES_GARBODOR (SINNOH_SPECIES_END+75)
#define SPECIES_ZORUA (SINNOH_SPECIES_END+76)
#define SPECIES_ZOROARK (SINNOH_SPECIES_END+77)
#define SPECIES_MINCCINO (SINNOH_SPECIES_END+78)
#define SPECIES_CINCCINO (SINNOH_SPECIES_END+79)
#define SPECIES_GOTHITA (SINNOH_SPECIES_END+80)
#define SPECIES_GOTHORITA (SINNOH_SPECIES_END+81)
#define SPECIES_GOTHITELLE (SINNOH_SPECIES_END+82)
#define SPECIES_SOLOSIS (SINNOH_SPECIES_END+83)
#define SPECIES_DUOSION (SINNOH_SPECIES_END+84)
#define SPECIES_REUNICLUS (SINNOH_SPECIES_END+85)
#define SPECIES_DUCKLETT (SINNOH_SPECIES_END+86)
#define SPECIES_SWANNA (SINNOH_SPECIES_END+87)
#define SPECIES_VANILLITE (SINNOH_SPECIES_END+88)
#define SPECIES_VANILLISH (SINNOH_SPECIES_END+89)
#define SPECIES_VANILLUXE (SINNOH_SPECIES_END+90)
#define SPECIES_DEERLING (SINNOH_SPECIES_END+91)
#define SPECIES_SAWSBUCK (SINNOH_SPECIES_END+92)
#define SPECIES_EMOLGA (SINNOH_SPECIES_END+93)
#define SPECIES_KARRABLAST (SINNOH_SPECIES_END+94)
#define SPECIES_ESCAVALIER (SINNOH_SPECIES_END+95)
#define SPECIES_FOONGUS (SINNOH_SPECIES_END+96)
#define SPECIES_AMOONGUSS (SINNOH_SPECIES_END+97)
#define SPECIES_FRILLISH (SINNOH_SPECIES_END+98)
#define SPECIES_JELLICENT (SINNOH_SPECIES_END+99)
#define SPECIES_ALOMOMOLA (SINNOH_SPECIES_END+100)
#define SPECIES_JOLTIK (SINNOH_SPECIES_END+101)
#define SPECIES_GALVANTULA (SINNOH_SPECIES_END+102)
#define SPECIES_FERROSEED (SINNOH_SPECIES_END+103)
#define SPECIES_FERROTHORN (SINNOH_SPECIES_END+104)
#define SPECIES_KLINK (SINNOH_SPECIES_END+105)
#define SPECIES_KLANG (SINNOH_SPECIES_END+106)
#define SPECIES_KLINKLANG (SINNOH_SPECIES_END+107)
#define SPECIES_TYNAMO (SINNOH_SPECIES_END+108)
#define SPECIES_EELEKTRIK (SINNOH_SPECIES_END+109)
#define SPECIES_EELEKTROSS (SINNOH_SPECIES_END+110)
#define SPECIES_ELGYEM (SINNOH_SPECIES_END+111)
#define SPECIES_BEHEEYEM (SINNOH_SPECIES_END+112)
#define SPECIES_LITWICK (SINNOH_SPECIES_END+113)
#define SPECIES_LAMPENT (SINNOH_SPECIES_END+114)
#define SPECIES_CHANDELURE (SINNOH_SPECIES_END+115)
#define SPECIES_AXEW (SINNOH_SPECIES_END+116)
#define SPECIES_FRAXURE (SINNOH_SPECIES_END+117)
#define SPECIES_HAXORUS (SINNOH_SPECIES_END+118)
#define SPECIES_CUBCHOO (SINNOH_SPECIES_END+119)
#define SPECIES_BEARTIC (SINNOH_SPECIES_END+120)
#define SPECIES_CRYOGONAL (SINNOH_SPECIES_END+121)
#define SPECIES_SHELMET (SINNOH_SPECIES_END+122)
#define SPECIES_ACCELGOR (SINNOH_SPECIES_END+123)
#define SPECIES_STUNFISK (SINNOH_SPECIES_END+124)
#define SPECIES_MIENFOO (SINNOH_SPECIES_END+125)
#define SPECIES_MIENSHAO (SINNOH_SPECIES_END+126)
#define SPECIES_DRUDDIGON (SINNOH_SPECIES_END+127)
#define SPECIES_GOLETT (SINNOH_SPECIES_END+128)
#define SPECIES_GOLURK (SINNOH_SPECIES_END+129)
#define SPECIES_PAWNIARD (SINNOH_SPECIES_END+130)
#define SPECIES_BISHARP (SINNOH_SPECIES_END+131)
#define SPECIES_BOUFFALANT (SINNOH_SPECIES_END+132)
#define SPECIES_RUFFLET (SINNOH_SPECIES_END+133)
#define SPECIES_BRAVIARY (SINNOH_SPECIES_END+134)
#define SPECIES_VULLABY (SINNOH_SPECIES_END+135)
#define SPECIES_MANDIBUZZ (SINNOH_SPECIES_END+136)
#define SPECIES_HEATMOR (SINNOH_SPECIES_END+137)
#define SPECIES_DURANT (SINNOH_SPECIES_END+138)
#define SPECIES_DEINO (SINNOH_SPECIES_END+139)
#define SPECIES_ZWEILOUS (SINNOH_SPECIES_END+140)
#define SPECIES_HYDREIGON (SINNOH_SPECIES_END+141)
#define SPECIES_LARVESTA (SINNOH_SPECIES_END+142)
#define SPECIES_VOLCARONA (SINNOH_SPECIES_END+143)
#define UNOVA_SPECIES_END SPECIES_VOLCARONA
#endif

#if GAME_GENERATION==4
#define LAST_SPECIES SINNOH_SPECIES_END
#define NUM_LEGENDARIES 8
#elif GAME_GENERATION==5
#define LAST_SPECIES UNOVA_SPECIES_END
#define NUM_LEGENDARIES 15
#else
#define LAST_SPECIES HOENN_SPECIES_END
#define NUM_LEGENDARIES 1
#endif

#if GAME_GENERATION>=4
#define SPECIES_DIALGA (LAST_SPECIES+1)
#define SPECIES_PALKIA (LAST_SPECIES+2)
#define SPECIES_HEATRAN (LAST_SPECIES+3)
#define SPECIES_GIRATINA (LAST_SPECIES+4)
#define SPECIES_CRESSELIA (LAST_SPECIES+5)
#define SPECIES_MANAPHY (LAST_SPECIES+6)
#define SPECIES_DARKRAI (LAST_SPECIES+7)
#define LAST_LEGENDARY SPECIES_DARKRAI
#endif

#if GAME_GENERATION>=5
#define SPECIES_VICTINI (LAST_LEGENDARY+1)
#define SPECIES_COBALION (LAST_LEGENDARY+2)
#define SPECIES_TERRAKION (LAST_LEGENDARY+3)
#define SPECIES_VIRIZION (LAST_LEGENDARY+4)
#define SPECIES_RESHIRAM (LAST_LEGENDARY+5)
#define SPECIES_ZEKROM (LAST_LEGENDARY+6)
#define SPECIES_KELDEO (LAST_LEGENDARY+7)
#endif

#define SPECIES_EGG (LAST_SPECIES+NUM_LEGENDARIES)
